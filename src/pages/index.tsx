            ...
            <Grid container spacing={3}>
              <Grid item xs={12} sm={smValue}>
                <FormControl fullWidth variant="outlined">
                  <InputLabel id="search-make">Marca</InputLabel>
                  <Field
                    name="make"
                    as={Select}
                    labelId="search-make"
              ...
              <Grid item xs={12} sm={smValue}>
                <FormControl fullWidth variant="outlined">
                  <InputLabel id="search-min-price">Precio mínimo</InputLabel>
                  <Field
                    name="minPrice"
                    as={Select}
              ...
              <Grid item xs={12} sm={smValue}>
                <FormControl fullWidth variant="outlined">
                  <InputLabel id="search-max-price">Precio máximo</InputLabel>
                  <Field
                    name="maxPrice"
                    as={Select}
...
export function ModelSelect({ initialMake, models, make, ...props }: ModelSelectProps) {
  ...
  return (
    <FormControl fullWidth variant="outlined">
      <InputLabel id="search-model">Modelo</InputLabel>
      <Select
        name="model"
